/** Barrel export so tests and fixtures import from one place. */
export { BasePage } from '@pages/base/BasePage';
export { VehicleListingPage } from '@pages/base/VehicleListingPage';
export { HomePage } from '@pages/HomePage';
export { NewCarsPage } from '@pages/NewCarsPage';
